...
```{r warning = FALSE, echo = FALSE, message = FALSE, fig.width= 8.5, fig.height= 3}

test <- read.csv("Y:/DA&DS/Data Scientists Only/SEM White Paper/net10_results.csv", header = T)
...
ggplot(test, aes(x=Group, y= Result, fill = Group))+
  geom_bar(stat = "identity")+
  facet_wrap(~Metric, scales = "free_y")+
  xlab('')+
  scale_fill_manual(values = c("#303030", "#C5A24C"))
