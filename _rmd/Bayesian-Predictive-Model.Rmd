...
summary_table <- summary(movies[,c(18)])

knitr::kable(summary_table, digits = getOption("digits"))
```
...
```{r, message = F, warnings = F, fig.align = 'center', echo = F}
ggpairs(movies, columns = c("feature_film", "audience_score"), 
        lower = list(continuous = "smooth"), aes(alpha = .6))
```
...
```{r, message = F, warnings = F, fig.align = 'center', echo = F}
ggpairs(movies, columns = c("drama", "audience_score"), 
        lower = list(continuous = "smooth"), aes(alpha = .6))
```
...
```{r, message = F, warnings = F, fig.align = 'center', echo = F}
ggpairs(movies, columns = c("mpaa_rating_R", "audience_score"), 
        lower = list(continuous = "smooth"), aes(alpha = .6))
```
...
```{r, message = F, warnings = F, fig.align = 'center', echo = F}
ggpairs(movies, columns = c("oscar_season", "audience_score"), 
        lower = list(continuous = "smooth"), aes(alpha = .6))
```

###Figure 3.5 Audience Score and Summer Season Summaries
```{r, message = F, warnings = F, fig.align = 'center', echo = F}
ggpairs(movies, columns = c("summer_season", "audience_score"), 
        lower = list(continuous = "smooth"), aes(alpha = .6))
```
...
```{r, message = F, warnings = F, fig.align = 'center'}
...
```{r, message = F, warnings = F, fig.align = 'center', fig.height=5}
